    ...
    <div className="min-h-screen bg-white text-slate-900 flex flex-col selection:bg-indigo-500 selection:text-white">
      ...
      <section className="relative pt-12 pb-20 md:pt-20 md:pb-28 overflow-hidden bg-gradient-to-b from-slate-50/70 via-white to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="max-w-4xl mx-auto rounded-2xl border border-slate-200/80 bg-white p-4 sm:p-6 shadow-xl text-left">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-4">
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-rose-400" />
                <div className="w-3 h-3 rounded-full bg-amber-400" />
                <div className="w-3 h-3 rounded-full bg-emerald-400" />
                <span className="text-xs font-semibold text-slate-400 ml-2">CareerPilotAI Diagnostic Preview</span>
              </div>
              <span className="text-xs font-bold text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-full border border-emerald-200">
                88% Match — Full Stack Developer
              </span>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100">
                <div className="text-[11px] font-medium text-slate-500">Skills Extracted</div>
                <div className="text-xl font-bold text-slate-900 mt-1">14 Verified</div>
                <div className="text-[11px] text-slate-500 mt-1">React, Node, SQL, Docker, TypeScript</div>
              </div>

              <div className="p-3.5 rounded-xl bg-indigo-50/60 border border-indigo-100">
                <div className="text-[11px] font-medium text-indigo-700">15-Question Quiz Score</div>
                <div className="text-xl font-bold text-indigo-900 mt-1">12 / 15 (80%)</div>
                <div className="text-[11px] text-amber-700 font-semibold mt-1">+3 Premium Credits Earned!</div>
              </div>

              <div className="p-3.5 rounded-xl bg-amber-50/60 border border-amber-100">
                <div className="text-[11px] font-medium text-amber-800">Skill Gap Diagnosis</div>
                <div className="text-xl font-bold text-amber-900 mt-1">Score: 68/100</div>
                <div className="text-[11px] text-amber-800 mt-1">Priority: SQL Indexing & Cloud CI/CD</div>
              </div>
            </div>
          </div>
        </div>
