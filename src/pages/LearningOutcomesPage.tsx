          ...
          >
            <div className="flex items-start justify-between gap-4 mb-4">
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <Link
                  to={`/learning/skill/${encodeURIComponent(item.topics?.[0] || item.career_name || 'JavaScript')}`}
                  className="px-2.5 py-1.5 rounded-lg text-[10px] font-bold bg-emerald-600 text-white hover:bg-emerald-700 transition-colors"
                >
                  Open Tutor
                </Link>
              </div>
